...
def conv_bn_relu_pool_forward(x, w, b, gamma, beta, conv_param, pool_param, bn_param):
    ...
    bn_res, bn_cache = spatial_batchnorm_forward(a, gamma, beta, bn_param)

    s, relu_cache = relu_forward(bn_res)
    out, pool_cache = max_pool_forward_fast(s, pool_param)
...
def conv_bn_relu_pool_backward(dout, cache):
    ...
    dbn_res, dgamma, dbeta = spatial_batchnorm_backward(da, bn_cache)
    dx, dw, db = conv_backward_fast(dbn_res, conv_cache)
    return dx, dw, db, dgamma, dbeta
